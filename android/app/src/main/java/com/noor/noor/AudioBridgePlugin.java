...
public class AudioBridgePlugin extends Plugin {
    ...
    static final String ACTION_PLAY  = "com.noor.noor.AUDIO_PLAY";
    static final String ACTION_PAUSE = "com.noor.noor.AUDIO_PAUSE";
    static final String ACTION_NEXT  = "com.noor.noor.AUDIO_NEXT";
    static final String ACTION_PREV  = "com.noor.noor.AUDIO_PREV";
    static final String ACTION_STOP  = "com.noor.noor.AUDIO_STOP";
